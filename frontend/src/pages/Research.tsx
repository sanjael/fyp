...
import { BookOpen, ShieldAlert, Cpu, Layers, CheckCircle2 } from 'lucide-react';
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '20px' }}>
        ...
        <div style={{ padding: '24px', background: 'var(--bg-panel)', borderRadius: '16px', border: '1px solid var(--border-color)' }}>
          ...
          <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '0.86rem', color: 'var(--text-muted)', lineHeight: 1.6 }}>
            <li><strong>Temporal Freshness ($TFF$):</strong> Exponential half-life decay ($\lambda = \ln 2 / 180\text{d}$).</li>
            <li><strong>Temporal Availability ($TAF$):</strong> Binary indicator of parseable publication date.</li>
            <li><strong>Source Credibility ($SCF$):</strong> Publication domain & publisher reputation score.</li>
            <li><strong>Evidence Consistency ($ECF$):</strong> Pairwise cosine similarity matrix among chunks.</li>
        ...
        <div style={{ padding: '24px', background: 'var(--bg-panel)', borderRadius: '16px', border: '1px solid var(--border-color)' }}>
          ...
          <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '0.86rem', color: 'var(--text-muted)', lineHeight: 1.6 }}>
            <li><strong>Backend:</strong> FastAPI + Python 3.10 (Uvicorn async)</li>
            <li><strong>Vector DB:</strong> ChromaDB PersistentClient</li>
            <li><strong>Embeddings:</strong> nomic-embed-text</li>
            <li><strong>LLM Generator:</strong> Ollama (Qwen2.5:latest)</li>
            <li><strong>ML Regressor:</strong> XGBoost Regressor</li>
